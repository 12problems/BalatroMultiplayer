return {
	descriptions = {
		...
		Joker = {
			...
			j_mp_speedrun = {
				...
				text = {
					...
					-- Keep this aligned with server SPEEDRUN_REWARD_WINDOW_SECONDS.
		...
		Back = {
			b_mp_testing = {
				name = "Testing Deck",
				text = {
					"Start run with {C:attention}3{} random",
					"{C:attention}Jokers{} and {C:attention}3{} random",
					"playing cards with {C:attention}seals",
				},
			},
			b_mp_testing_2 = {
				name = "Testing 2",
				text = {
					"Start run with {C:attention}Let's Go Gambling{},",
					"{C:attention}Skip Off{}, {C:attention}Taxes{}, and",
					"{C:attention}2{} copies of {C:attention}Oops! All 6s{}",
				},
			},
			b_mp_cocktail = {
				name = "Cocktail Deck",
	...
	misc = {
		...
		dictionary = {
			...
			b_opts_team_card_sync = "Playing Cards",
			b_opts_team_hand_level_sync = "Poker Hand Level",
			...
			b_players = "Players",
			b_make_host = "Make Host",
			b_kick = "Kick",
			b_beat_average_mode = "Scoring Mode",
			b_send_money = "Send",
			b_view_all = "VIEW ALL",
			b_max_players = "Max Players",
			k_group_options = "Party Options",
			k_team_options = "Shared Progress",
			k_lobby_type = "Party Mode",
			k_highest_score = "Highest",
			k_beat_average = "Average",
			k_median = "Median",
			k_geometric = "Geometric",
			k_custom_score = "Custom",
			k_custom_winners = "Winners",
			k_custom_winners_percent = "Winners %",
			k_transfer_money = "Transfer money",
			...
			k_customize_preview = "Customize Calculator Text:",
...
k_legacy_ranked_description = "A minimal competitive ruleset.\n\nNo Multiplayer cards or balance changes\nexcept Glass. Has locked settings:\n- Attrition gamemode\n- The Order enabled",
			...
			k_coop = "Co-op",
			k_coop_description = "Work together against normal blinds. Blind score requirements scale with the number of active players.",
			k_weekly = "Weekly",
			...
			k_teammate_jokers = "Teammate Jokers",
			k_player_jokers = "Player Jokers",
			k_your_jokers = "Your Jokers",
			k_enemy_deck = "Enemy Deck",
			k_teammate_deck = "Teammate Deck",
			k_player_deck = "Player Deck",
			k_nemesis_deck = "Enemy Deck",
			...
			k_score_calculator = "Score Calculator",
			k_score_calculator_original_desc = "Fast, perfect for vanilla (non-modded) gameplay.",
			k_score_calculator_experimental_desc = "Supports modded content, but is slower and more resource-intensive.",
			...
			ml_score_calculator_backend_opt = {
				"Original Engine",
				"Experimental Engine",
			},
